...
interface OrderAutoCompletedEmailProps {
...
export default function OrderAutoCompletedEmail({
  recipientName = "User",
  orderId,
  listingTitle,
  orderUrl,
}: OrderAutoCompletedEmailProps) {
  return (
    <Tailwind
      config={{
        theme: {
          ...
          <Container className="mx-auto max-w-[600px] rounded-lg bg-brand-surface p-8 shadow-lg">
            <Section className="mb-8 text-center">
              ...
              <Text className="mt-2 text-base text-brand-muted">
                {recipientName}, the inspection period for this order has expired without dispute.
              </Text>
            </Section>
            ...
            <Section className="mb-6">
              <Text className="m-0 text-base leading-relaxed text-brand-muted">
                The buyer did not open a dispute or confirm delivery within the 24-hour inspection window. The funds have been automatically released to the seller and the order is now complete.
              </Text>
            </Section>
            ...
            <Section className="text-center">
              <Text className="m-0 text-xs text-gray-500">
                AssetXtack Escrow System. Funds have been released securely.
              </Text>
            </Section>
          </Container>
        </Body>
