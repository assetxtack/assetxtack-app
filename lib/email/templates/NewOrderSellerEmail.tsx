...
export default function NewOrderSellerEmail({
  sellerName = "Seller",
  orderId,
  listingTitle,
  payoutAmount,
          ...
          <Container className="mx-auto max-w-[600px] rounded-lg bg-brand-surface p-8 shadow-lg">
            <Section className="mb-8 text-center">
              ...
              <Text className="mt-2 text-base text-brand-muted">
                Great news, {sellerName}! A buyer has completed payment.
              </Text>
            </Section>
            ...
            <Section className="mb-6">
              <Text className="m-0 text-base leading-relaxed text-brand-muted">
                The buyer&apos;s payment has been verified and securely locked in
                the vault. You now have <strong className="text-white">24 hours</strong> to
                submit your account credentials to complete the trade.
              </Text>
            </Section>
            ...
            <Section className="text-center">
              <Text className="m-0 text-xs text-gray-500">
                AssetXtack Escrow System. Funds are protected until delivery is
                confirmed.
              </Text>
            </Section>
          </Container>
