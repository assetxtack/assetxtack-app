...
interface AutoRefundEmailProps {
...
export default function AutoRefundEmail({
  recipientName = "User",
  orderId,
  listingTitle,
  orderUrl,
        ...
        <Body className="bg-brand-dark m-0 px-0 font-sans">
          <Container className="mx-auto max-w-[600px] rounded-lg bg-brand-surface p-8 shadow-lg">
            <Section className="mb-8 text-center">
              <Heading className="m-0 text-3xl font-bold text-rose-400">
                Refund Processed
              </Heading>
              <Text className="mt-2 text-base text-brand-muted">
                {recipientName}, your dispute has been resolved automatically.
              </Text>
            </Section>
            ...
            <Section className="mb-6 rounded-lg border border-gray-700 bg-black/30 p-6">
              ...
              <Hr className="my-4 border-gray-700" />
              <Text className="m-0 text-sm text-brand-muted">Amount Refunded</Text>
              <Text className="m-0 text-lg font-semibold text-emerald-400">
                {amountText || "Full amount"}
              </Text>
            </Section>

            <Section className="mb-6">
              <Text className="m-0 text-base leading-relaxed text-brand-muted">
                <strong className="text-brand-gold">Reason:</strong> {reason}
              </Text>
            </Section>
            ...
            <Section className="text-center">
              <Text className="m-0 text-xs text-gray-500">
                AssetXtack Escrow System. This is an automated resolution message.
              </Text>
            </Section>
          </Container>
        </Body>
